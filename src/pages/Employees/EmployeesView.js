...
const [addadvance,setAddAdvance]=useState(false)
  ...
  <g id="Group_5230" data-name="Group 5230" transform="translate(0 0)">
    ...
    <g id="Group_5509" data-name="Group 5509" transform="translate(51.768 55.614)">
      ...
      <Button type="" className="addsavebtn" onClick={() => props.onReceivechildProps(false, "close")}>{props.actionbtn} </Button>
    </>
  );
    ...
    return (
      ...
      <p className={addadvance ? "totaloutstandupdate" : "totaloutstandingtxt"}>
        Total Outstanding
      </p>
      <div className='advancetxt'>
        <p className='advanceno'>200000</p>
      </div>
      <Button type="" className={addadvance ? "addadvancebtn" : "addadvance"} onClick={()=>setAddAdvance(true)} >Add Advance</Button>
      {addadvance ? (
<>
      <Input placeholder="Add New Advance" style={{ height: "50px", marginTop: "30px" }} />
      {/* <Input placeholder="Date" style={{ height: "50px", marginTop: "30px" }} /> */}
      <DatePicker className="daterangepicker" 
